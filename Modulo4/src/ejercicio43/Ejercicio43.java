...
public class Ejercicio43 {
	...
	//Letters of the DNI	
	enum Letters {T,R,W,A,G,M,Y,F,P,D,X,B,N,J,Z,S,Q,V,H,L,C,K,E};
	
	static Letters [] arrayLetters = Letters.values();

	public static void main(String[] args) {
		
		//Request a 8 digits number and create a chain
		...
		int position =modulusSum-1;
		Letters letterOfNif = arrayLetters [position];
