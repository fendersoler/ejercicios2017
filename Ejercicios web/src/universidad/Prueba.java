...
public class Prueba {
	...
	public static void main(String[] args) {	
		...
		Aula aula1 = new Aula();	
		System.out.println("Impresión para control:");
		...
		//Comprobamos si hay más del 50% de alumnos para dar clase
		...
		if (aulaYProfe == true && aulaYAlumnos == true){
			...
			System.out.println("------------------------------------------");
			//Mostramos cuantos alumnos y alumnas (por separado) están aprobados
