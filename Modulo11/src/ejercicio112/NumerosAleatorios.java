...
public class NumerosAleatorios {
	...
	public static void main(String[] args) {
		...
		System.out.println("Cantidad de números a generar: " + cantidadDeNumerosAGenerar);
		...
		System.out.println("Contador de números generados en total: " + contadorDeNumersoGenerados);
		System.out.println("Números en el TreeSet: " + numeros.size());
	}
}